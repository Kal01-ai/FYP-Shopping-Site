              ...
              <div class="col-sm">
                  <div class="card customCard">
                      <div class="card-body">
                          ...
                          <a href="about-us.php" class="btn btn-info">About Us</a>
                      </div>
                  </div>
              </div>
              <div class="col-sm">
                <div class="card customCard">
                    <div class="card-body">
                        ...
                        <p class="card-text">Learn more by clicking the button below.</p>
                        <a href="product.php" class="btn btn-info">Our Products</a>
                    </div>
                </div>
            </div>
            <div class="col-sm">
                <div class="card customCard">
                    <div class="card-body">
                        ...
                        <a href="contact-us.php" class="btn btn-info">Contact Us</a>
                    </div>
                </div>
            </div>
          </div>
